...
export const CompanySwitcher = forwardRef(
  function Switcher({ companies, selectedCompany, isOpen, toggleOpen, ...rest }: Props, ref?: ForwardedRef<HTMLDivElement>) {
    ...
    return (
      ...
      >
        <CompanyListContainer isOpen={isOpen}>
          ...
          <AddSection>
            <IconButton label="Add new company" Icon={<AddIcon />} isSmall styles={addButtonStyled} />
