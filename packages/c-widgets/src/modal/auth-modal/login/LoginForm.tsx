...
import {Button, Input, LinkButton, PasswordInput} from "@freelbee/features/common";
import {
  Breakpoint,
  Color,
  IconPosition,
            ...
            <Form onSubmit={sendForm}>
                <ToSignUpTextForMobile>
                    ...
                    <LinkButton
                        as='button'
                        type='button'
                        onClick={() => { console.log('go to the registration')
                ...
                <Fields>
                    ...
                    <PasswordContainer>
                        ...
                        <ButtonContainer>
                            <MapButtonSwitchAuth
                                onClick={() => { console.log('go to password recovery')
