                ...
                <PersonalInfo>
                    ...
                    <Fields>
                        <Input
                            ...
                            setValue={(v) => { handleInput(v, 'email')}}
                    ...
                    <Fields>
                        <PasswordInput
                            ...
                            setValue={(v) => { handleInput(v, 'password')}}
                        ...
                        <PasswordInput
                            ...
                            setValue={(v) => { handleInput(v, 'repeatPassword')}}
                ...
                <AgreementsAndButtonContainer>
                    <Agreements>
                        ...
                        <Statement>
                          <Text font='body' as='p'>
                            I agree with{' '}
                            <LinkButton as='Link' href={`https://freelbee-docs.s3.eu-north-1.amazonaws.com/General+Terms+and+Conditions+Freelbee+Service.pdf`} target={`_blank`}>
                              the General Terms and Conditions.
                            </LinkButton>

                            {' '}I agree with{' '}
                            <LinkButton as='Link' href={`https://freelbee-docs.s3.eu-north-1.amazonaws.com/Privacy+Policy.pdf`} target={`_blank`}>
                              the terms of Privacy Policy
                            </LinkButton>
                            {' '}and{' '}
                            <LinkButton as='Link' href={`https://freelbee-docs.s3.eu-north-1.amazonaws.com/AML_KYC+Policy.pdf`} target={`_blank`}>
                              KYC & AML Policy
                            </LinkButton>
                            .
                          </Text>
